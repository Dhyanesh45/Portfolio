...
const EXPERIENCE = [
  {
    ...
    highlights: [
      ...
      'Conducted exploratory data analysis (EDA) and statistical investigations on large, complex healthcare datasets to identify trends, anomalies, and actionable insights.',
      ...
      'Built ETL/ELT data pipelines using Azure Data Factory (ADF) to ingest and transform data from hospital management systems into Azure Databricks and modern data lake environments.',
      'Worked with Azure Databricks to support scalable data storage and analytics-ready datasets for reporting and downstream integrations.',
      'Led a large-scale data migration of over 2 TB from Teradata to Azure Databricks, significantly improving application performance and reporting efficiency.',
      ...
      'Created recurring and ad-hoc reports for senior leadership, translating complex datasets into clear, actionable insights to support operational and strategic decision-making.',
      'Developed and executed DML and DDL SQL commands to manage database structures, manipulate datasets, and support reporting requirements.',
      'Developed KPI dashboards in MicroStrategy by integrating curated Databricks datasets and ETL pipelines, leveraging DevOps and CI/CD practices for efficient data solution delivery.',
      'Applied data governance, security, and anonymization best practices while managing sensitive healthcare data.',
      'Analyzed operational and customer service metrics to identify process gaps, detect trends, and recommend data-driven improvements.',
      'Conducted quality assurance, regression testing, and validation to ensure reporting accuracy and system reliability.',
    ],
    tags: ['Azure Databricks', 'MicroStrategy', 'PySpark', 'ETL/ELT', 'SQL', 'Power BI', 'ADF'],
  },
  {
